...
def main():
    df = pd.read_csv("Dataset/adult-training.csv", header=None)
    ...
    df = df.drop(['fnlwgt', 'education', 'capital_gain', 'capital_loss'], 1)
    # df['income'] = pd.get_dummies(df.income)
    df = df.replace(to_replace={'employer': {' Without-pay': ' Never-worked'}, 'relationship': {' Husband': 'Spouse', ' Wife': 'Spouse'}})
    for col in ['workclass', 'marital_status', 'occupation', 'relationship', 'race', 'sex', 'income']:
    ...
    plt.xlim([1, 50])
    plt.savefig('AdultPlots/AdultmaxdepthGini.png')
    plt.close()
    ...
    plt.xlabel('Max Depth')
    plt.xlim([1, 50])
    plt.savefig('AdultPlots/AdultmaxdepthEntropy.png')
    plt.close()
    ...
    dt_cv = RandomizedSearchCV(learner, n_jobs=1, param_distributions=params, refit=True, n_iter=20)
    ...
    plot_learning_curve(train_scores, test_scores, train_sizes, 'AdultPlots/AdultDTLearningCurve.png')
    ...
    # plt.xlabel('Max Depth')
    # plt.xlim([1, 50])
    # plt.savefig('AdultPlots/Adultboostedmaxdepth.png')
    # plt.close()
    #
    # Adaboost Estimators
    ...
    # plt.xlim([1, 50])
    # plt.savefig('AdultPlots/Adultboostedestimators.png')
    # plt.close()
    #
    ...
    # plt.xlim([0, 1])
    # plt.savefig('AdultPlots/AdultboostedLearningRate.png')
    # plt.close()
    ...
    # boost_cv = RandomizedSearchCV(learner, n_jobs=1, param_distributions=params, refit=True, n_iter=20)
    ...
    #     random_state=seed)
    #
    # plot_learning_curve(train_scores, test_scores, train_sizes, 'AdultPlots/AdultboostedLearningCurve.png')
    ...
    # plt.xlim([1, 50])
    # plt.savefig('AdultPlots/AdultKNN.png')
    # plt.close()
    #
    # KNN Weight
    ...
    #     random_state=seed)
    #
    # plot_learning_curve(train_scores, test_scores, train_sizes, 'AdultPlots/AdultKNNLearningCurve.png')
    ...
    # plt.xlim([1, 50])
    # plt.savefig('AdultPlots/AdultANNNeurons.png')
    # plt.close()
    ...
    # plt.xlim([1, 50])
    # plt.savefig('AdultPlots/AdultANNLayers.png')
    # plt.close()
    ...
    #     random_state=seed)
    #
    # plot_learning_curve(train_scores, test_scores, train_sizes, 'AdultPlots/AdultANNLearningCurve.png')
    ...
    #     random_state=seed)
    #
    # plot_learning_curve(train_scores, test_scores, train_sizes, 'AdultPlots/AdultSVCLearningCurve.png')
